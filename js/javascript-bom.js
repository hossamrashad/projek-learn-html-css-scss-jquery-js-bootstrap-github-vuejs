 ...
 * -- مجموعة من الابجاكت تتحكم فى البروزار
 *
...
var myTime = setInterval(countDown1, 1000);
...
// explain document.cookie("name=value; expires=Date; path=");

// Add Cookies

// Name = FavFont | value = Droid

// expires = new Date(); | Date End Cookies

// Get Date

// new Date();

// path = / = All Pages || /PageName.html = This Page Only

document.cookie = "FavFont=Droid; expires=Thu Aug 10 2022 13:52:19 GMT+0200; path=/";